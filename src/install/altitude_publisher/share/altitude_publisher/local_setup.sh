...
: ${AMENT_CURRENT_PREFIX:="/home/ulugbek/dev-ws/src/install/altitude_publisher"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/altitude_publisher/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/altitude_publisher/environment/path.sh"
